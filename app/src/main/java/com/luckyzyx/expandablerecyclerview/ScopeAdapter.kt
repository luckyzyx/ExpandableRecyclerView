...
import com.luckyzyx.expandablerecyclerview.databinding.FuncItemBinding
import com.luckyzyx.expandablerecyclerview.databinding.ScopeItemBinding
    ...
    override fun onBindChildViewHolder(
        ...
        if (payloads.isEmpty()){
            (holder as FuncVH).apply {
                itemBinding.title.text = child.title.toString()
    ...
    override fun onBindGroupViewHolder(
        ...
        if (payloads.isEmpty()){
            (holder as ScopeVH).apply {
                itemBinding.title.text = group.title.toString()
            }
        }
    }
